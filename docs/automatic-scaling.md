...
3. Install `pip install -e '.[compile,service]'` and `pip install -e 'adapters/python[smf]'`. Set the SEMP variables, `SOLACE_ASSIGNMENT_API_KEY` and application credentials using your secret manager.
